...
public class EuaService {
    ...
    public EuaService(RabbitTemplate template, EuaRepository euaRepository, ObjectMapper objectMapper, ModelMapper modelMapper) {
    ...
    public Message pushToMqAndSaveToDb(MessageTO message) throws JsonProcessingException {
    ...
    public void pushToMq(String abdmGatewayURl, String searchEndpoint, EuaRequestBody searchRequest, String requestString, String requestMessageId, String clientId) {
        ...
        searchRequest.getContext().setProvider_uri(url);
