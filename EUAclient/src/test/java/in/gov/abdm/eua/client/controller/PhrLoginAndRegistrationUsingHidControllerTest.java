...
import in.gov.abdm.eua.client.dto.phr.LoginViaMobileEmailRequestResponse;
import in.gov.abdm.eua.client.dto.phr.SearchResponsePayLoad;
import in.gov.abdm.eua.client.dto.phr.login.AuthConfirmResponse;
import in.gov.abdm.eua.client.dto.phr.login.AuthInitResponse;
import in.gov.abdm.eua.client.dto.phr.registration.HidResponse;
import in.gov.abdm.eua.client.dto.phr.registration.JwtResponseHid;
...
public class PhrLoginAndRegistrationUsingHidControllerTest {
    ...
    public void whenGivenNullRequestForFindUserByHealthId_shouldGive400BadReq() {
        ...
        Assertions.assertThat(controller.findUserByHealthId(null, null)).isEqualTo(errorResponse);
    }
...
// TC for /registration/hid/confirm-init begins
    ...
    public void givenNullRequestForConfirmInit_ShouldReturn400Error() throws Exception {
        ...
        ResponseEntity<HidResponse> errorBody = ResponseEntity.status(HttpStatus.BAD_REQUEST).body(hidResponse);
        Assertions.assertThat(controller.verifyUserOtp(null,null)).isEqualTo(errorBody);
    }
...
// TC for /registration/hid/create/phrAddress begins
    ...
    public void givenNullRequestForCreatePhr_ShouldReturn400Error() throws Exception {
        ...
        ResponseEntity<JwtResponseHid> errorBody = ResponseEntity.status(HttpStatus.BAD_REQUEST).body(response);
        Assertions.assertThat(controller.createPhrAddress(null,null)).isEqualTo(errorBody);
    }
...
public void givenNullRequestForHidLoginAuthInit_ShouldGiveBadReq() {
    ...
    response.setError("Request cannot be null");
    response.setCode("400");
    ResponseEntity<LoginViaMobileEmailRequestResponse> errorBody = ResponseEntity.status(HttpStatus.BAD_REQUEST).body(response);
    Assertions.assertThat(controller.generateOtpForHidLogin(null,null, null)).isEqualTo(errorBody);
}
...
//TC for/login/hid/search/auth-mode begins
    ...
    public void givenNullRequestForLoginSearchAuthMode_SHouldGiveBadReq() {
        SearchResponsePayLoad response = new SearchResponsePayLoad();
        response.setError("Request cannot be null");
        response.setCode("400");
        Assertions.assertThat(controller.searchUserByHealthIdForLogin(null,null, null)).isEqualTo(ResponseEntity.status(HttpStatus.BAD_REQUEST).body(response));
    }
...
//TC for/login/hid/search/auth-init begins
    ...
    public void givenNullRequestForLoginPhrAuthInit_ShouldReturnBadReq() {
        ...
        response.setError("Request cannot be null");
        response.setCode("400");
        Assertions.assertThat(controller.generateOtpPhrLogin(null,null, null)).isEqualTo(ResponseEntity.status(HttpStatus.BAD_REQUEST).body(response));
    }
...
//TC for/login/hid/search/auth-confirm begins
    ...
    public void givenNullRequestForLoginPhrAuthConfirm_ShouldReturnBadReq() {
        AuthConfirmResponse response = new AuthConfirmResponse();
        response.setError("Request cannot be null");
        response.setCode("400");
        Assertions.assertThat(controller.verifyOtpPhrLogin(null,null, null)).isEqualTo(ResponseEntity.status(HttpStatus.BAD_REQUEST).body(response));
    }
